 ...
 */
class TicTacBuilder(dependency: ParentComponent) : ViewBuilder<TicTacView, TicTacRouter, TicTacBuilder.ParentComponent>(dependency) {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      internal fun router(
          component: Component,
          view: TicTacView,
          interactor: TicTacInteractor): TicTacRouter {
